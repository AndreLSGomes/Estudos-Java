...
public class PercorrendoArrayForEach {
	...
	public static void main(String[] args) {
		...
		// Exibindo os �ndices e os valores do array com FOR
		...
		// Declara��o de uma �nica linha array bidimensional
		...
		// Array an�nimo
		System.out.println("Array an�nimo");
		int x[];
		x = new int[] {17, 38, 10};
